...
INSERT INTO slots (id, role, correct, distractors) VALUES
  ...
  ('sl-a-to-music-2', 'A', 'to music', '["music","at music","for music"]'::jsonb),
  ...
  ('sl-s-they-4', 'S', 'they', '["them","their","theirs"]'::jsonb),
...
INSERT INTO sentence_slot_refs (sentence_id, slot_index, slot_id) VALUES
  ...
  ('s-vt1-anchor', 2, 'sl-a-to-music-2'),
