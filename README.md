...
- **词汇记忆** — 看图，倒计时里先想那句英文，再 Aha! / Forgot / Got it。词汇按学习价值排序（动词>名词>代词&冠词>介词>形容词>副词，同词性内按词频降序；兼类词按 Brown 语料中实际最高频的**主导词性**归组，二语习得/口语速成理念），每批约 50 词、批内出示随机防死记，每次练习 10 个词汇，Forgot 进复习。揭示后可把例句「加入我的挑战」，也可对整词报错。
